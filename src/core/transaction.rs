...
impl Transaction {
    /// Tính toán Hash ID của giao dịch (SHA-256)
    ...
    /// Xác thực chữ ký số (Ed25519)
    pub fn verify(&self) -> bool {
        // 1. Decode Sender Address (Public Key)
...
/// Bộ nhớ tạm chứa các giao dịch chưa được đóng gói vào Block
#[derive(Clone)]
pub struct Mempool {
...
impl Mempool {
    ...
    /// Thêm giao dịch vào Pool (trả về false nếu đã tồn tại)
    ...
    /// Lấy n giao dịch để đóng gói vào Block và xóa khỏi Pool
